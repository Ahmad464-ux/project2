...
import 'package:final_proj_52030331/List_Emergency.dart';
...
class _DeleteEmergencyState extends State<DeleteEmergency> {
  ...
  Future<void> loadEmergencyData() async {
    String url = "http://localhost/php_files/listemergency.php";
  ...
  Future<void> deleteEmergencyData() async {
    ...
    try {
      var response = await http.post(
        Uri.parse("http://localhost/php_files/Deleteemergency.php"),
        headers: {
